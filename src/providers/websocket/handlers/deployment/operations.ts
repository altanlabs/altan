...
import type {
  WebSocketDeploymentEvent,
  ExtractedDeploymentEvent,
  DeploymentEventData,
  DeploymentOperationsRegistry,
} from './types';
import {
 ...
 */
export const extractDeploymentEventData = (
  data: WebSocketDeploymentEvent,
): ExtractedDeploymentEvent | null => {
 ...
 */
export const handleDeploymentCreated = (eventData: DeploymentEventData): void => {
  dispatch(
    addInterfaceDeployment({
      id: eventData.id,
 ...
 */
export const handleDeploymentUpdated = (eventData: DeploymentEventData): void => {
 ...
 */
export const handleDeploymentDeleted = (eventData: DeploymentEventData): void => {
 ...
 */
export const DEPLOYMENT_OPERATIONS: DeploymentOperationsRegistry = {
