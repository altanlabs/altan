  ...
  return (
    ...
    >
      ...
      <m.div variants={varFade().inUp}>
        ...
        >
          Altan will provide you support if you have any problems, our support team will reply
...
const avatarImage = (index) =>
  `https://api-dev-minimal-v5.vercel.app/assets/images/avatar/avatar_${index + 2}.jpg`;
