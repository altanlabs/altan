          ...
          <div className="flex-shrink-0">
            {isRunning ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all group"
              >
                ...
                <Iconify
                  icon="mdi:chat-processing-outline"
                  className="w-5 h-5 text-gray-600 dark:text-gray-400 transition-transform group-hover:scale-110"
                />
              </button>
            )}
          </div>
