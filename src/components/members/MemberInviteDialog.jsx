...
import MembersAutocomplete from './MembersAutocomplete.jsx';
...
import { selectMe } from '../../redux/slices/room/selectors';
import { inviteMembers } from '../../redux/slices/room/thunks';
...
const MemberInviteDialog = () => {
  ...
  const handleSendInvite = useCallback(() => {
    ...
    dispatch(inviteMembers(invitation)).then(() => {
