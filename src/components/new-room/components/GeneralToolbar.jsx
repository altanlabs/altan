...
import { selectTabsCount, selectMainThread } from '../../../redux/slices/room/selectors';
import { createTab } from '../../../redux/slices/room/slices/tabsSlice';
...
const GeneralToolbar = ({
  ...
  return (
    <div
      className={cn(
        'relative left-0 right-0 z-10 top-0 flex flex-col transition-all duration-500 px-1 bg-transparent',
        className,
      )}
    >
      {/* Tab Bar */}
