...
import { Server, ChevronDown, ChevronUp, Cpu, HardDrive, Crown, Loader2, Key, Globe, Copy, Eye, EyeOff, DollarSign, Wrench, Rocket } from 'lucide-react';
                            ...
                            isDisabled
                              ...
                              : 'cursor-pointer'
                                  ...
                                  isSelected
                                    ...
                                    : 'border-border/70 bg-gradient-to-br from-muted/40 to-background/20 hover:border-indigo-400 hover:shadow-xl'
                                }`}
                              >
                                {isSelected && (
                              ...
                              <m.div
                                ...
                                className={`group relative overflow-hidden rounded-xl border-2 p-4 transition-all ${
                                  ...
                                  isSelected
                                    ...
                                    : 'border-border/70 bg-gradient-to-br from-muted/40 to-background/20 hover:border-emerald-400 hover:shadow-xl'
                                }`}
                        >
                                {isSelected && (
