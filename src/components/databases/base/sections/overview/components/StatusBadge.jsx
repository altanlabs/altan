...
export const StatusBadge = ({ base, isPaused, metrics, onClick }) => {
  return (
    <m.div
      ...
      className={`flex-shrink-0 flex items-center gap-3 px-4 py-3 rounded-xl bg-white dark:bg-gray-800/50 backdrop-blur-sm self-start ${
    ...
    >
      ...
      <div className="flex flex-col min-w-0">
        <span
          className={`text-sm font-semibold ${isPaused ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400'}`}
        >
