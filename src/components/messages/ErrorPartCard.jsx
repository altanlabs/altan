...
const ErrorPartCard = ({ partId }) => {
  ...
  console.log('[ErrorPartCard] Part:', part);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center gap-1.5 px-2.5 py-1.5 text-xs group"
      >
        <Icon
          icon="mdi:alert-circle-outline"
          className="w-3.5 h-3.5 text-red-500 dark:text-red-400 flex-shrink-0 opacity-70"
        />
        <span className="flex-1 text-left font-medium text-red-800 dark:text-red-200">
