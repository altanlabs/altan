...
import { Avatar, Box, Divider, Stack, TextField, Typography, useTheme } from '@mui/material';
              ...
              <ul>
                <div 
                  style={{
                    ...
                    alignItems: 'center',
                    minWidth: 300,
                    ...bgBlur({ color: theme.palette.background.default, opacity: 0.6 })
                  }}
                >
                  
                  <TextField variant="filled" label="Search members." size="small" sx={{ minWidth: 300, px:1, fontSize: '8px' }}/>
