...
const DemoTextVoicePage = () => {
  ...
  const { isConnected, isConnecting, startConversation, stopConversation, conversation } =
      ...
      >
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          ...
          <Typography
            ...
            paragraph
          >
            Test both text messaging and voice conversation capabilities with transcripts. Using
            Altan Agent ID: <code>{DEMO_AGENT_ID}</code>
          </Typography>
          ...
          <Alert
            ...
            sx={{ mb: 2 }}
          >
            This demo shows: • Voice conversation with real-time transcripts • Text message sending
            via contextual updates • Complete conversation history and analytics
          </Alert>
                          ...
                          secondary={
                            <Typography
                              ...
                              sx={{
                                mt: 1,
                                fontFamily:
                                  message.type === 'voice_event' ? 'monospace' : 'inherit',
                ...
                <Box sx={{ maxHeight: 200, overflow: 'auto' }}>
                  {userTranscripts.length === 0 ? (
                    ...
                    userTranscripts.map((transcript) => (
                      <Box
                        key={transcript.id}
                        sx={{ mb: 1, p: 1, bgcolor: '#e3f2fd', borderRadius: 1 }}
                      >
                ...
                <Box sx={{ maxHeight: 200, overflow: 'auto' }}>
                  {agentResponses.length === 0 ? (
                    ...
                    agentResponses.map((response) => (
                      <Box
                        key={response.id}
                        sx={{ mb: 1, p: 1, bgcolor: '#f3e5f5', borderRadius: 1 }}
                      >
