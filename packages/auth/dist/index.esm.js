...
function ProtectedRoute({ children, redirectTo = "/login", }) {
    ...
    if (!isAuthenticated) {
        return jsxRuntimeExports.jsx(Navigate, { to: redirectTo, replace: true });
    }
