...
export default function SignIn(_a) {
    ...
    return (_jsx("div", { className: `min-h-screen flex items-center justify-center ${theme.background}`, children: _jsxs("div", { className: `max-w-md w-full space-y-8 ${theme.card} p-10 rounded-xl shadow-lg`, children: [_jsxs("div", { children: [_jsx("h2", { className: `text-center text-3xl font-bold ${theme.text}`, children: companyName ? `Sign in to ${companyName}` : "Sign in" }), _jsx("p", { className: `mt-2 text-center text-sm ${theme.textMuted}`, children: "Welcome back! Please sign in to continue" })] }), _jsx("button", { onClick: () => continueWithGoogle(), className: `w-full flex justify-center py-2 px-4 border rounded-md shadow-sm text-sm font-medium ${theme.googleButton}`, children: _jsxs("span", { className: "flex items-center", children: [_jsx(Google, {}), _jsx("span", { className: "ml-2", children: "Continue with Google" })] }) }), _jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-0 flex items-center", children: _jsx("div", { className: `w-full border-t ${appearance.theme === 'dark' ? 'border-gray-700' : 'border-gray-300'}` }) }), _jsx("div", { className: "relative flex justify-center text-sm", children: _jsx("span", { className: `px-2 ${theme.card} ${theme.textMuted}`, children: "or" }) })] }), _jsxs("form", { className: "mt-8 space-y-6", onSubmit: handleSubmit, children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "email", className: `block text-sm font-medium ${theme.text}`, children: "Email address" }), _jsx("input", { id: "email", type: "email", required: true, className: `mt-1 block w-full border rounded-md shadow-sm py-2 px-3 ${theme.input}`, value: email, onChange: (e) => setEmail(e.target.value) })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "password", className: `block text-sm font-medium ${theme.text}`, children: "Password" }), _jsx("input", { id: "password", type: "password", required: true, className: `mt-1 block w-full border rounded-md shadow-sm py-2 px-3 ${theme.input}`, value: password, onChange: (e) => setPassword(e.target.value) })] }), error && (_jsx("div", { className: `rounded-md ${theme.error.background} p-4`, children: _jsxs("div", { className: "flex", children: [_jsx("div", { className: "flex-shrink-0", children: _jsx("svg", { className: `h-5 w-5 ${theme.error.icon}`, viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z", clipRule: "evenodd" }) }) }), _jsx("div", { className: "ml-3", children: _jsx("p", { className: `text-sm font-medium ${theme.error.text}`, children: error.message }) })] }) })), _jsx("button", { type: "submit", className: `w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ${theme.button}`, disabled: isLoading, children: isLoading ? "Signing in..." : "Continue" })] }), _jsxs("div", { className: `mt-8 border-t ${appearance.theme === 'dark' ? 'border-gray-700' : 'border-gray-200'} pt-6`, children: [withSignUp && (_jsxs("div", { className: "text-center mb-4", children: [_jsx("span", { className: theme.textMuted, children: "Don't have an account? " }), _jsx("a", { href: signUpUrl, onClick: handleSignUpClick, className: "text-blue-600 hover:text-blue-400", children: "Sign up" })] })), _jsxs("div", { className: `flex items-center justify-center space-x-2 text-xs ${theme.textMuted}`, children: [_jsx("span", { children: "Secured by" }), _jsx("img", { src: appearance.theme === "dark"
